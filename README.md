...
- 🎬 **Превью видео и фото** - изображения и видео квартир отображаются прямо в Telegram
...
## 🎬 Превью видео и фото в Telegram

Парсер автоматически извлекает изображения и видео из объявлений и отправляет их в Telegram:

- **Видео** 🎥 - если в объявлении есть видео, оно отправляется через Telegram API и воспроизводится прямо в чате
- **Фото** 📸 - если видео нет, отправляется первое изображение из галереи объявления
- **Текст** 📝 - если нет медиа, отправляется текстовое сообщение с активной ссылкой

Все детали объявления (цена, размер, количество комнат, адрес, описание) включаются как подпись к медиа.

**Преимущества:**
- ✅ Сразу видно, как выглядит квартира
- ✅ Не нужно переходить по ссылке для просмотра фото/видео
- ✅ Быстрее принимать решение о просмотре
- ✅ Видео воспроизводятся прямо в Telegram
