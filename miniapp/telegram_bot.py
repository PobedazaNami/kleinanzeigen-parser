...
async def _send_setup_complete_notification(context: ContextTypes.DEFAULT_TYPE, target_id: str, target_lang: str):
    ...
    The menu is generated by _user_menu_keyboard() and automatically includes
    the "Add more cities" button for users with active subscriptions (trial or paid).
    Users without active subscriptions will see only the "Try 14 days FREE" button.
